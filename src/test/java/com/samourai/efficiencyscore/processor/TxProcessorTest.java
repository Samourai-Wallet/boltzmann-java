...
public class TxProcessorTest {
    ...
    public void testCheckCoinjoinPattern() {
        ...
        outs.put("18JNSFk8eRZcM8RdqLDSgCiipgnfAYsFef", 9850000);
        outs.put("1PA1eHufj8axDWEbYfPtL8HXfA66gTFsFc", 1270000);
        outs.put("1JR3x2xNfeFicqJcvzz1gkEhHEewJBb5Zb", 100000);
        outs.put("1ALKUqxRb2MeFqomLCqeYwDZK6FvLNnP3H", 100000);
        processCheckCoinjoinPattern(outs, 2, new CoinjoinPattern(2, 100000));
    }

    private void processCheckCoinjoinPattern(Map<String, Integer> outs, int maxNbEntities, CoinjoinPattern expected) {
