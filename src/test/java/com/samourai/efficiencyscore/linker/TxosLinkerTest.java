...
public class TxosLinkerTest {
    ...
    private void processUnpackTxos(Map<String, Long> currentTxos, Pack pack, Map<String,Long> expectedTxos, int expectedPackIdx) {
    ...
    public void testUnpackLinkMatrix_onePackAlone() {
        ...
        int[][] matLnk = new int[][]{
            new int[]{1}, new int[]{11}
        };

        int[][] expectedMatLnk = new int[][]{
            new int[]{1, 1, 1, 1}, new int[]{11, 11, 11, 11}
        };
    ...
    public void testUnpackLinkMatrix_onePackFollowedByOtherInputs() {
        ...
        int[][] matLnk = new int[][]{
            new int[]{1, 4, 5}, new int[]{11, 44, 55}
        };

        int[][] expectedMatLnk = new int[][]{
            new int[]{1, 1, 1, 1, 4, 5}, new int[]{11, 11, 11, 11, 44, 55}
        };
    ...
    public void testUnpackLinkMatrix_onePackPreceededByOtherInputs() {
        ...
        int[][] matLnk = new int[][]{
            new int[]{4, 5, 1}, new int[]{44, 55, 11}
        };

        int[][] expectedMatLnk = new int[][]{
            new int[]{4, 5, 1, 1, 1, 1}, new int[]{44, 55, 11, 11, 11, 11}
        };
    ...
    public void testUnpackLinkMatrix_onePackSurroundedByOtherInputs() {
        ...
        int[][] matLnk = new int[][]{
            new int[]{4, 5, 1, 6, 7}, new int[]{44, 55, 11, 66, 77}
        };
    ...
    private void unpackLinkMatrix(int[][] matLnk, Txos txos, Pack pack, int[][] expectedMatLnk, Txos expectedTxos) {
